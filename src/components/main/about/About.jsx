  ...
  render() {
    return (
      <div className="about-wrapper position-relative">
        ...
        {/* <header className="row m-0 p-0 about-header mx-auto">
          <div className="bg-danger header-description row col-lg-8 col-md-12 mt-1 pl-0 pr-lg-3 pr-md-0 mx-md-auto">
            <div className="col-lg-2 col-md-0 p-0 m-0"></div>
